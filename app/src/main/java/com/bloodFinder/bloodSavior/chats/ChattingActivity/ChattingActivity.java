package com.bloodFinder.bloodSavior.chats.ChattingActivity;
...
/*        //Custom ActionBar
    ...
    private void sendMessage(String message, String messageType, String pushID) {
        ...
        if(Util.internetAvailable(ChattingActivity.this)){
            try {
                if (message != "") {
                        ...
                        public void onComplete(@Nullable DatabaseError error, @NonNull DatabaseReference ref) {
                            if (error != null) {
                                ...
                                if (messageType.equals(Constants.MESSAGE_TYPE_TEXT)) {
                                    notificationTitle = getString(R.string.newMessageFrom, UtilDB.USER_NAME);
                                } else if (messageType.equals(Constants.MESSAGE_TYPE_IMAGE)) {
                                    notificationTitle = getString(R.string.newImageReceivedFrom, UtilDB.USER_NAME);
                                    //notificationMessage = getString(R.string.imageReceived);
                                } else if (messageType.equals(Constants.MESSAGE_TYPE_VIDEO)) {
                                    notificationTitle = getString(R.string.newVideoReceivedFrom,UtilDB.USER_NAME);
            ...
            Util.noInternetConnection(ChattingActivity.this);
        }
