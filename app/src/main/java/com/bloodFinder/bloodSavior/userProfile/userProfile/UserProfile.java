package com.bloodFinder.bloodSavior.userProfile.userProfile;
...
public class UserProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Util.internetAvailable(UserProfile.this)){
            iv_profilePicture = findViewById(R.id.iv_profilePicture_userProfileActivity);
            cv_chat = findViewById(R.id.cv_chat_userProfileActivity);
            cv_call = findViewById(R.id.cv_call_userProfileActivity);
            ...
            tv_emptyListText = findViewById(R.id.tv_emptyListText_userProfileActivity);
            ...
            cv_chat.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(Util.internetAvailable(UserProfile.this)){
                        ...
                        Util.noInternetConnection(UserProfile.this);
                    }
        ...
        mRootRef.child(NodeNames.POSTS_ORDER_BY_USER).child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    arcLoader.stop();
                    arcLoader.setVisibility(View.GONE);
                    tv_emptyListText.setVisibility(View.VISIBLE);
                }
            }
