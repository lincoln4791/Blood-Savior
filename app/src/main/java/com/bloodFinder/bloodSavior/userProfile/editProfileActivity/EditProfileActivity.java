package com.bloodFinder.bloodSavior.userProfile.editProfileActivity;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_saveData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(Util.internetAvailable(EditProfileActivity.this)){
                    saveData();
                }else{
                    Util.noInternetConnection(EditProfileActivity.this);
                }
