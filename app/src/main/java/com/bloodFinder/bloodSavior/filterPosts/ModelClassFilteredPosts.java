package com.bloodFinder.bloodSavior.filterPosts;

public class ModelClassFilteredPosts {
    ...
    public ModelClassFilteredPosts(String postCreatorName, String postCreatorPhoto) {
        this.postCreatorName = postCreatorName;
        this.postCreatorPhoto = postCreatorPhoto;
    }

    public ModelClassFilteredPosts(String bloodGroup, String district, String postDescription, String postImage, String area,
    ...
    public ModelClassFilteredPosts(String postCreatorName, String postCreatorPhoto, String bloodGroup, String district,
                                   String postDescription, String postImage, String area, String postLove, String postView,
                                   String timeStamp, String postCreatorID, String postID, String cause, String gender, String accepted,
                                   String donated, String phone, String unitBag, String requiredDate, String loveCheckerFlag,
                                   String acceptedFlag, String completedFlag, String post_order) {
        this.postCreatorName = postCreatorName;
        this.postCreatorPhoto = postCreatorPhoto;
        this.bloodGroup = bloodGroup;
        this.district = district;
