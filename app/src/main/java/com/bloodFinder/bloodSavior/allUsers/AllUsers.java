package com.bloodFinder.bloodSavior.allUsers;
...
import com.bloodFinder.bloodSavior.allUsers.searchByName.SearchByName;
...
public class AllUsers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_search.setOnClickListener(v -> {
            if(Util.internetAvailable(AllUsers.this)){
                arcLoader.start();
               ...
               Util.noInternetConnection(AllUsers.this);
            }
    ...
    private void fetchAllUsers() {
        ...
        if(Util.internetAvailable(this)){
            mRootRef.child(NodeNames.USERS).addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
