...
public class AdapterSearchByName extends RecyclerView.Adapter<AdapterSearchByName.MyVIewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull MyVIewHolder holder, int position) {
        ...
        holder.cv_holder_sampleAllUsers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent userProfileIntent = new Intent(context, UserProfile.class);
                userProfileIntent.putExtra(Extras.USER_ID,modelClassSearchByNameListFiltered.get(position).getUserID());
