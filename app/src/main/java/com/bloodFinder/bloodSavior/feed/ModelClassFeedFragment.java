...
public class ModelClassFeedFragment {
    ...
    public static void loadProfilePicture(ImageView imageView, String imageUrl){
        Glide.with(imageView).load(imageUrl).placeholder(R.drawable.ic_profile_picture)
                .error(R.drawable.ic_profile_picture).into(imageView);
    }

    @BindingAdapter("android:loadPostImage")
    public static void loadPostImage(ImageView imageView, String imageUrl){
        Glide.with(imageView).load(imageUrl).placeholder(R.drawable.featuredd)
                .error(R.drawable.featuredd).into(imageView);
    }
