package com.bloodFinder.bloodSavior.posts.editRequestPost;
...
public class EditRequest extends AppCompatActivity {
    ...
    private TextView tv_requiredDate,tv_selectDistrict;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_selectDistrict = findViewById(R.id.tv_selectDistrict_editRequestActivity);
        ...
        tv_selectDistrict.setOnClickListener(v -> {
    ...
    private void getIntentData() {
        ...
        Log.d("tag","completed Flagg"+completedFlag);
        postImage = "";
    ...
    private void updateRequest() {
        ...
        if(Util.internetAvailable(EditRequest.this)){
            if(bloodList.isEmpty()){
                ...
                if(genderList.isEmpty()){
                    ...
                    if(causeList.isEmpty()){
                        ...
                        district = tv_selectDistrict.getText().toString();
                        area = et_area.getText().toString();
                        postDescription = et_postDescription.getText().toString();
                        phone =et_phone.getText().toString();

                        if(district.equals("")){
                            tv_selectDistrict.setError(getString(R.string.enterDistrict));
                        }
            ...
            Util.noInternetConnection(EditRequest.this);
        }
    ...
    private void setEditTextsData() {
        tv_selectDistrict.setText(district);
