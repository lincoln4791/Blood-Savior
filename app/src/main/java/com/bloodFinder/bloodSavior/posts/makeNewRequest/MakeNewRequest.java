package com.bloodFinder.bloodSavior.posts.makeNewRequest;
...
import com.bloodFinder.bloodSavior.selectCountry.SelectCountry;
...
public class MakeNewRequest extends AppCompatActivity {
    ...
    private EditText et_area, et_postDescription,et_phone;
    private ImageView iv_postImage,iv_cancelImagePreview,iv_back;
    ...
    private static final int REQUEST_CODE_GALLARY_ACCESS = 101;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.toolbar_makeNewRequest);
        getSupportActionBar().hide();
        getSupportActionBar().setCustomView(toolbar);

        tv_district = findViewById(R.id.tv_district_makeNewRequestActivity);
        ...
        iv_back = findViewById(R.id.iv_back_toolbar_makeNewRequest);
        ...
        cv_datePicker.setOnClickListener(v -> requiredDate = getDate());
        ...
        btnMakeRequest.setOnClickListener(v -> makeNewRequest());


        cv_uploadImage.setOnClickListener(v -> imagePicker());
        ...
        iv_cancelImagePreview.setOnClickListener(v -> {
    ...
    private void makeNewRequest() {
     ...
     if(Util.internetAvailable(MakeNewRequest.this)){
         if(bloodList.isEmpty()){
             ...
             if(genderList.isEmpty()){
                 ...
                 if(causeList.isEmpty()){
                     ...
                     if(district.equals("")){
                         tv_district.setError(getString(R.string.enterDistrict));
                     }
         ...
         Util.noInternetConnection(MakeNewRequest.this);
     }
    ...
    private void imagePicker() {
        ...
        startActivityForResult(intent, REQUEST_CODE_GALLARY_ACCESS);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode== REQUEST_CODE_GALLARY_ACCESS){
