package com.bloodFinder.bloodSavior.mainActivity;
...
import com.bloodFinder.bloodSavior.aboutUs.AboutUs;
...
import com.bloodFinder.bloodSavior.chats.ChatsFragment;
import com.bloodFinder.bloodSavior.feed.FeedFragment;
import com.bloodFinder.bloodSavior.donations.DonationsFragment;
import com.bloodFinder.bloodSavior.notificationPage.NotificationActivity;
import com.bloodFinder.bloodSavior.userProfile.ProfileFragment;
import com.bloodFinder.bloodSavior.posts.RequestsFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_notification.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, NotificationActivity.class)));

        if(Util.internetAvailable(MainActivity.this)){
            getFeaturdeImageUri();
            loadProfile();
            setViewPager();
        }
        else{
            Util.noInternetConnection(MainActivity.this);
        }
        ...
        dbrTokensMy.setValue(null).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(MainActivity.this, getString(R.string.somethingWentWrong,task.getException()), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void getFeaturdeImageUri(){
        StorageReference featuredImageRef = FirebaseStorage.getInstance().getReference().child("featured_coronaawarness.jpg");
        featuredImageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                    UtilDB.FEATURED_IMAGE_URI = uri;
            }
        });
    }
